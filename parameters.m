...
CC.nn = 53;  %number of elements in the negative electrode
CC.ns = 11;  %number of elements in the separator
CC.np = 51; %number of elements in the positive electrode
